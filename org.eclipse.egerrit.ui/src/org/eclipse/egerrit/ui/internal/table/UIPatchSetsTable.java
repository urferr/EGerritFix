...
import org.eclipse.egerrit.ui.internal.table.model.PatchSetsTableModel;
...
/**
 * This class implements the files patch set table view.
 *
 * @since 1.0
 */
public class UIPatchSetsTable {
	...
	public TableViewer createTableViewerSection(Composite aParent, GridData layoutData) {
		...
		layout.numColumns = PatchSetsTableModel.values().length;
...
//		fViewer.getTable().addListener(SWT.MouseDown, mouseButtonListener);
	...
	/**
	 * Create each column for the List of Patch set
	 *
	 * @param aParent
	 * @param aViewer
	 */
...
//					+ tableInfo[index].getMoveable());
		...
		table.addControlListener(new ControlAdapter() {
			...
			public void controlResized(ControlEvent e) {
				...
				int newCommitWidth = minCommitWidth;
				...
				//Id and Role column
				table.getColumn(PatchSetsTableModel.COMMIT.ordinal()).setWidth(newCommitWidth);
				table.getColumn(PatchSetsTableModel.AUTHOR.ordinal()).setWidth(newAuthorWidth);
