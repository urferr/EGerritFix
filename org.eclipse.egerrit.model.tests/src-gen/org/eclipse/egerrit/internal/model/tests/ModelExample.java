...
public class ModelExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.model")); //$NON-NLS-1$
				RelatedChangeAndCommitInfo root = ModelFactory.eINSTANCE.createRelatedChangeAndCommitInfo();
