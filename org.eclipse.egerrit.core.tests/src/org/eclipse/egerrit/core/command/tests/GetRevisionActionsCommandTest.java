...
public class GetRevisionActionsCommandTest {
	...
	/**
	 * Test method for {@link org.eclipse.egerrit.core.command.GetRevisionsActionsCommand#GetRevisionsActionsCommand()}
	 */
	@Test
	public void testGetRevisionsActionsCommand() {
		// Run test
		GetRevisionActionsCommand command = fGerrit.getRevisionActions("", "");

		// Verify result
		assertEquals("Wrong repository", fRepository, command.getRepository());
		assertEquals("Wrong return type", new TypeToken<Map<String, ActionInfo>>() {
		}.getType(), command.getReturnType());
	}

	/**
	 * Test method for {@link org.eclipse.egerrit.core.command.GetRevisionActionsCommand#formatRequest()}
	 */
	@Test
	public void testFormatRequest() {
		...
		assertEquals("Wrong path", fGerrit.getRepository().getPath() + "/changes//revisions//actions", uri.getPath());
	...
	public void testCall() {
		...
		// Run test
		GetRevisionActionsCommand command = fGerrit.getRevisionActions(change_id, revision_id);
