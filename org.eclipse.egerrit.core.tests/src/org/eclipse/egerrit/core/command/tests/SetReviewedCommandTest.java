...
public class SetReviewedCommandTest {
	...
	/**
	 * Test method for
	 * {@link org.eclipse.egerrit.core.command.SetReviewedCommand#GetChangeCommand(org.eclipse.egerrit.core.GerritRepository)}
	 */
	@Test
	public void testSetReviewedCommand() {
		// Run test
		SetReviewedCommand command = fGerrit.setReviewed("", "", "");

		// Verify result
		assertEquals("Wrong repository", fRepository, command.getRepository());
		assertEquals("Wrong return type", null, command.getReturnType());
	}

	/**
	 * Test method for {@link org.eclipse.egerrit.core.command.SetReviewedCommand#formatRequest()}
	 */
	@Test
	...
	public void testCall() throws Exception {
		final String FILENAME = "EGerritTestReviewFile.java";
