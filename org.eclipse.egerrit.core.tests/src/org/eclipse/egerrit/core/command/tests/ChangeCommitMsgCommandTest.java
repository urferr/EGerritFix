...
public class ChangeCommitMsgCommandTest {
	...
	/**
	 * Test method for
	 * {@link org.eclipse.egerrit.core.command.ChangeCommitMsgCommand#ChangeCommitMessageInChangeEditCommand(org.eclipse.egerrit.core.GerritRepository)}
	 */
	@Test
	public void testChangeCommitMsgCommand() {
		// Run test
		ChangeCommitMsgCommand command = fGerrit.editMessage("");
	...
	/**
	 * Test method for {@link org.eclipse.egerrit.core.command.ChangeCommitMsgCommand#formatRequest()}
	 */
	@Test
	public void testFormatRequest() {
		...
		assertEquals("Wrong path", fGerrit.getRepository().getPath() + "/a/changes//edit:message", uri.getPath());
