...
/**
 * Test suite for {@link org.eclipse.egerrit.core.command.RestoreCommand}
 *
 * @since 1.0
 */
...
public class RestoreCommandTest {
	...
	/**
	 * Test method for
	 * {@link org.eclipse.egerrit.core.command.RestoreCommand#RestoreCommand(org.eclipse.egerrit.core.GerritRepository)}
	 */
	@Test
	public void testRestoreCommand() {
		// Run test
		RestoreCommand command = fGerrit.restore("");
	...
	public void testFormatRequest() {
		...
		assertEquals("Wrong path", fGerrit.getRepository().getPath() + "/a/changes//restore", uri.getPath());
