...
public class PublishChangeEditCommandTest {
	...
	/**
	 * Test method for
	 * {@link org.eclipse.egerrit.core.command.PublishChangeEditCommand#PublishChangeEditCommand(org.eclipse.egerrit.core.GerritRepository)}
	 */
	@Test
	public void testPublishChangeEditCommand() {
		// Run test
		PublishChangeEditCommand command = fGerrit.publishChangeEdit("");
	...
	/**
	 * Test method for {@link org.eclipse.egerrit.core.command.PublishChangeEditCommand#formatRequest()}
	 */
	@Test
	public void testFormatRequest() {
		...
		assertEquals("Wrong path", fGerrit.getRepository().getPath() + "/a/changes//edit:publish", uri.getPath());
...
//	@Test
	public void testCall() {
		...
		String editMessageCmdResult = null;
		try {
