...
/**
 * Test suite for {@link org.eclipse.egerrit.internal.core.command.RebaseRevisionCommand}
 *
 * @since 1.0
 */
@SuppressWarnings("nls")
public class RebaseRevisionCommandTest extends CommandTestWithSimpleReview {
	@Test
	public void testCall() throws Exception {
		...
		// rebase the change ...
		RebaseRevisionCommand rebaseCmd = fGerrit.rebase(change_id, commit_id);
		try {
			rebaseCmd.call();
		} catch (EGerritException e) {
