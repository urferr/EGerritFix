...
/**
 * This is the item provider adapter for a {@link org.eclipse.egerrit.internal.model.ProjectInfo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectInfoItemProvider extends ItemProviderAdapter
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ProjectInfo_id_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ProjectInfo_id_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ProjectInfo_type"), //$NON-NLS-1$
						ModelPackage.Literals.PROJECT_INFO__ID, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ProjectInfo_name_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ProjectInfo_type"), //$NON-NLS-1$
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ProjectInfo_parent_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ProjectInfo_parent_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ProjectInfo_type"), //$NON-NLS-1$
						ModelPackage.Literals.PROJECT_INFO__PARENT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ProjectInfo_state_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ProjectInfo_state_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ProjectInfo_type"), //$NON-NLS-1$
						ModelPackage.Literals.PROJECT_INFO__STATE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.PROJECT_INFO__BRANCHES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case ModelPackage.PROJECT_INFO__ID:
		case ModelPackage.PROJECT_INFO__NAME:
		case ModelPackage.PROJECT_INFO__PARENT:
		case ModelPackage.PROJECT_INFO__DESCRIPTION:
		case ModelPackage.PROJECT_INFO__STATE:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case ModelPackage.PROJECT_INFO__BRANCHES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ModelPackage.Literals.PROJECT_INFO__BRANCHES,
