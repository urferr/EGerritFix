...
package org.eclipse.egerrit.dashboard.ui.internal.commands.my;
...
/**
 * This class implements the Dashboard-Gerrit UI my drafts comments reviews handler.
 * 
 * @since 1.0
 */
...
public class MyDraftCommentsReviewsHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent aEvent) throws ExecutionException {
		...
		reviewTableView.processCommands(ChangeState.HAS_DRAFT.getValue());
