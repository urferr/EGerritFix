...
abstract class BaseCommandChangeAndRevision<T> extends BaseCommand<T> {
	private static final String CHANGE_ID = "{change-id}"; //$NON-NLS-1$

	private static final String REVISION_ID = "{revision-id}"; //$NON-NLS-1$

	protected BaseCommandChangeAndRevision(GerritRepository gerritRepository, AuthentificationRequired authRequired,
