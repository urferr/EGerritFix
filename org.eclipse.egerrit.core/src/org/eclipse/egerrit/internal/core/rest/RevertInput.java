 ...
 * <a href="https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#revert-input">RevertInput</a>
 *
 * @since 1.0
 */
public class RevertInput {
	...
	public boolean equals(Object obj) {
		...
		RevertInput other = (RevertInput) obj;
		if (message == null) {
	...
	public String toString() {
		return "RevertInput [message=" + message + "]";
	}
