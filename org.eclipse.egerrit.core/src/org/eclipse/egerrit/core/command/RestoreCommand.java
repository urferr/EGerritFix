 ...
 * @since 1.0
 */
public class RestoreCommand extends PostCommand<ChangeInfo> {
	 ...
	 *            the change-id
	 */
	public RestoreCommand(GerritRepository gerritRepository, String id) {
	 ...
	 * @param restoreInput
	 */
	public void setRestoreInput(RestoreInput restoreInput) {
		fRestoreInput = restoreInput;
	}
	...
	public HttpRequestBase formatRequest() {
		...
		// Serialize.
		String json = gson.toJson(fRestoreInput);
