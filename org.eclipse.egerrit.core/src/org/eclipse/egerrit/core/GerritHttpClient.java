...
/**
 * A wrapper for the actual HttpClient. Adds handling of authentication and
...
public class GerritHttpClient {
    ...
    /**
     * @param repository The gerrit repository
     * @param acceptSSC Indicates if self-signed certificates should be accepted
    ...
    public GerritHttpClient(GerritRepository repository, boolean acceptSSC, GerritCredentials creds) {
        ...
        try {
            ...
            if (acceptSSC) {
                builder.setSslcontext(new SSLContextBuilder().loadTrustMaterial(null,
                        new TrustStrategy() {
                            @Override
