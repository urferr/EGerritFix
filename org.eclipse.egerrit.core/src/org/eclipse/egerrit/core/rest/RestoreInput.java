 ...
 * href="https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#submit-input">RestoreInput</a>
 *
 * @since 1.0
 */
public class RestoreInput {
	...
	public boolean equals(Object obj) {
		...
		RestoreInput other = (RestoreInput) obj;
		if (message == null) {
	...
	public String toString() {
		return "RestoreInput [message=" + message + "]";
	}
