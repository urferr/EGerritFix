...
/**
 * The <a href=
 * "http://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#fetch-info"
 * >FetchInfo</a> entity contains information about how to fetch a patch set via
 * a certain protocol.
 * <p>
...
public class FetchInfo {
    ...
    /**
     * @return The download commands for this patch set as a map that maps the
     *         command names to the commands. Only set if download commands are
     *         requested.
     */
    ...
    public String toString() {
        return "FetchInfo [url=" + url + ", ref=" + ref + ", commands="
                + commands + "]";
    }
