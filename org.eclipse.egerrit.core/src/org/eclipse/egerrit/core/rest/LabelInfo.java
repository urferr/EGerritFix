...
/**
 * The <a href=
 * "http://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#label-info"
 * >LabelInfo</a> entity contains information about a label on a change, always
 * corresponding to the current patch set.
 * <p>
 * There are two options that control the contents of LabelInfo: LABELS and
 * DETAILED_LABELS.
 * <ul>
 * <li>For a quick summary of the state of labels, use LABELS.
 * <li>For detailed information about labels, including exact numeric votes for
 * all users and the allowed range of votes for the current user, use
 * DETAILED_LABELS.
 * </ul>
 * <p>
...
public class LabelInfo {
    ...
    /**
     * @return The voting value of the user who recommended/disliked this label.
     *         May be null.
     */
    ...
    /**
     * @return A map of each voting value to its description for this label. May
     *         be null.
     */
    ...
    public int hashCode() {
        ...
        result = prime * result
                + ((default_value == null) ? 0 : default_value.hashCode());
        result = prime * result
                + ((disliked == null) ? 0 : disliked.hashCode());
    ...
    public String toString() {
        return "LabelInfo [optional=" + optional + ", approved=" + approved
                + ", rejected=" + rejected + ", recommended=" + recommended
                + ", disliked=" + disliked + ", blocking=" + blocking
