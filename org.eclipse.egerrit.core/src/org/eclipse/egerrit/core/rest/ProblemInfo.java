...
/**
 * The <a href=
 * "http://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#problem-info"
 * >ProblemInfo</a> entity contains information about an approval from a user
...
public class ProblemInfo {
    ...
    /**
     * @return The status of fixing the problem (FIXED, FIX_FAILED). May be
     *         null.
     */
    ...
    /**
     * @return If status is set, an additional plaintext message describing the
     *         outcome of the fix.
     */
    ...
    public String toString() {
        return "ProblemInfo [message=" + message + ", status=" + status
                + ", outcome=" + outcome + "]";
    }
