...
/**
 * The <a href= "http://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#change-message-info" >
 * ChangeMessageInfo</a> entity contains information about a message attached to a change.
 * <p>
...
public class ChangeMessageInfo {
	...
	public String toString() {
		return "ChangeMessageInfo [id=" + id + ", author=" + author + ", date=" + date + ", message=" + message
