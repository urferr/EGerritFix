...
/**
 * The
 * <a href= "http://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#approval-info" >ApprovalInfo</a>
...
public class ApprovalInfo extends AccountInfo {
	...
	/**
	 * @return The vote that the user has given for the label. If present and zero, the user is permitted to vote on the
	 *         label. May be null in which case the user is not permitted to vote on that label.
	 */
