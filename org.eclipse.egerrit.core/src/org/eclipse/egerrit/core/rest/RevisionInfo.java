 ...
 * >RevisionInfo</a> entity contains information about a patch set. Not all
 * fields are returned by default. Additional fields are obtained by adding o
 * parameters to the Query Changes.
 * <p>
 ...
 */
    ...
    /**
     * @return Whether the patch set has one or more draft comments by the
     *         calling user. Only set if DRAFT_COMMENTS option was requested.
     */
    ...
    /**
     * @return Information about how to fetch this patch set. The fetch
     *         information is provided as a map that maps the protocol name
     *         (“git”, “http”, “ssh”) to FetchInfo entities. This information is
     *         only included if a plugin implementing the download commands
    ...
    /**
     * @return The files of the patch set as a map that maps the file names to
     *         FileInfo entities. Only set if CURRENT_FILES or ALL_FILES option
     *         was requested.
     */
    ...
    /**
     * @return Actions the caller might be able to perform on this revision. The
     *         information is a map of view name to ActionInfo entities. May be
     *         null.
     */
    ...
    /**
     * @return Indicates whether the caller is authenticated and has commented
     *         on the current revision. Only set if REVIEWED option is
    ...
    public String toString() {
        return "RevisionInfo [draft=" + draft + ", has_draft_comments="
                + has_draft_comments + ", _number=" + _number + ", ref=" + ref
                + ", fetch=" + fetch + ", commit=" + commit + ", files="
                + files + ", actions=" + actions + ", reviewed=" + reviewed
                + "]";
    }
